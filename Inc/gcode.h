...
#define MAX_TABLE_SIZE_X 600
#define MAX_TABLE_SIZE_Y 400
...
uint8_t cnc_line(double x, double y, double z, double extruder_length, double length, double feed_rate);
void cnc_end(void);
void cnc_extruder_stop(void);
void cnc_extruder_on(void );
//extruder_t.c removed 20.03.13 void cnc_extruder_t(int temperature, int isWait);
