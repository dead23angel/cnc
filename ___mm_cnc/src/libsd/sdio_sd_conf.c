...
void SD_LowLevel_Init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC | RCC_AHB1Periph_GPIOD | SD_CD_CLK, ENABLE);
  ...
  /*!< Configure SD_CD_PIN pin: SD Card detect pin */
  GPIO_InitStructure.GPIO_Pin = SD_CD_PIN;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN; // Áûכמ GPIO_PuPd_UP
  GPIO_Init(SD_CD_PORT, &GPIO_InitStructure);

  /*!< Configure SD_WP_PIN pin: SD Card write protect pin */
